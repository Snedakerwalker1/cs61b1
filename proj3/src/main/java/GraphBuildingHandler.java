...
//            System.out.println("Beginning a way...");
            ...
            long newId = Long.parseLong(attributes.getValue("ref"));
            currentWay.add(newId);
            ...
            if (k.equals("maxspeed")) {
                ...
                isOk = ALLOWED_HIGHWAY_TYPES.contains(v);
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            g.addNodeName(activeLNode, attributes.getValue("v"));
